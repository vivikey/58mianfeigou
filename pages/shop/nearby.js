...
var pageObj = {
    data: {
        ...
        version: '',
        location: '',
        classNavList: [ { caption: '3km', value: 3 }, { caption: '5km', value: 4 }, { caption: '10km', value: 10 }, { caption: '15km', value: 15 }, { caption: '20km', value: 20 }, { caption: '50km', value: 50 }, { caption: '100km', value: 100 }],
        classNavActIdx:0,
        nearByList:[]
    },
    ...
    getNearByList(distance){
        ...
        FrontEndStore.NearBy({ user_id: app.USER_ID(), user_location: long_lat, distance}).then(r=>{
